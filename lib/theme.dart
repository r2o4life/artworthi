...
class AppFonts {
  static String get editorial => GoogleFonts.inter().fontFamily ?? 'Inter';
  static String get telemetry => GoogleFonts.jetBrainsMono().fontFamily ?? 'JetBrains Mono';
}

/// Cyber-Editorial palette (dark-first).
class AppColors {
  // Surfaces
  static const obsidian = Color(0xFF0B0B0C);
  static const obsidian2 = Color(0xFF0F1012);
  static const panelFill = Color(0xFF101114);
  static const panelFillStrong = Color(0xFF14161A);
  static const panelStroke = Color(0xFF252830);

  // Typography
  static const textPrimary = Color(0xFFF5F5F7);
  static const textSecondary = Color(0xFFB7BCC7);

  // Accents
  static const accentCyan = Color(0xFF00F0FF);
  static const accentEmerald = Color(0xFF00FF66);
  static const accentAmber = Color(0xFFFFB800);
}

class AppGradients {
  static const cyberObsidian = LinearGradient(
...
ThemeData get darkTheme => ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    primaryContainer: AppColors.panelFillStrong,
    ...
    surface: AppColors.obsidian2,
    onSurface: AppColors.textPrimary,
    surfaceContainerHighest: AppColors.panelFill,
    onSurfaceVariant: AppColors.textSecondary,
    outline: AppColors.panelStroke,
  ...
  navigationBarTheme: NavigationBarThemeData(
    backgroundColor: Colors.transparent,
    indicatorColor: AppColors.panelFillStrong,
    labelTextStyle: WidgetStatePropertyAll(
      TextStyle(fontFamily: AppFonts.telemetry, letterSpacing: 0.6, color: AppColors.textSecondary),
    ),
  ),
